...
El servidor multimedia establece `mediaReporting.chapterDetails.isCompleted = true` cuando se recibe un evento de [capítulo completado](/help/implementation/events/chapters/chapter-complete.md). La métrica se recoge en la llamada de cierre del capítulo. Los capítulos omitidos o abandonados a mitad del juego no se cuentan como finalizaciones.
