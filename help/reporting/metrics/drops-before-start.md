...
El servidor multimedia establece `mediaReporting.qoeDataDetails.isDroppedBeforeStart = true` para sesiones que se cierran sin producir un evento `media.play` en el contenido principal. La métrica se recoge en la llamada de cierre.
...
| Customer Journey Analytics | [`mediaReporting.qoeDataDetails.isDroppedBeforeStart`](https://experienceleague.adobe.com/es/docs/experience-platform/xdm/data-types/qoe-data-details-reporting) |
