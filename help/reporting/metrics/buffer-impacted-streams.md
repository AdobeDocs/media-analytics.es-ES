...
El servidor multimedia establece `mediaReporting.qoeDataDetails.hasBufferImpactedStreams = true` la primera vez que se recibe un evento `media.bufferStart` durante la sesión. La métrica se recoge en la llamada de cierre.
