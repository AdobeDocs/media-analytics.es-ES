...
El servidor multimedia incrementa el campo `count` en la entrada `fullscreen` de `mediaReporting.states[]` en cada evento de inicio de estado a pantalla completa. La métrica se recoge en la llamada de cierre.
...
| Customer Journey Analytics | [`mediaReporting.states[]`](https://experienceleague.adobe.com/es/docs/experience-platform/xdm/data-types/media-reporting-details) entrada donde `name = "fullscreen"`, campo `count` |
