...
SDK genera automáticamente el ID del pod de anuncios cuando se activa `media.adBreakStart`. Las implementaciones de API directas lo construyen a partir del índice de interrupción y la hora de inicio, o proporcionan un ID de pod personalizado.
