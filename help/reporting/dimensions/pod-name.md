...
El nombre de la secuencia proviene del valor [Ad break name](/help/implementation/variables/ads/ad-break-name.md) que el reproductor establece en `media.adBreakStart`.
...
Cada elemento es el nombre literal de la pausa publicitaria registrado en `media.adBreakStart`.
