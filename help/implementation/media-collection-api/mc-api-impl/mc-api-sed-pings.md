...
description: Los eventos ping son el latido del complemento de recopilación de medios de streaming. Aprenda a enviar un ping temporizado para el contenido principal o el seguimiento de anuncios.
...
Los eventos de ping son el &quot;latido&quot; del complemento de recopilación de medios de streaming. Los únicos parámetros requeridos para una llamada de ping son `eventType: ping` y el objeto `playerTime` (posición del cursor de encabezado y la marca de tiempo).
