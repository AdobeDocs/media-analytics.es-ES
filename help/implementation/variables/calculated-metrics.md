...
description: Obtenga información acerca de las métricas calculadas y las fórmulas de métricas en los servicios de medios de streaming.
...
Las métricas calculadas para los servicios de medios de streaming de Adobe son métricas personalizadas que le permiten obtener datos de medios de streaming orientados, como el tiempo promedio invertido en la publicidad o el promedio de anuncios por flujo de medios.
...
| Tasa de finalización de medios | Tasa de contenido completado frente a medio iniciado (%) | `Content Completes/ Media Starts` |
| Tasa de finalización de contenido | Relación de contenido finalizado frente a contenido iniciado (%) | `Content Completes / Content Starts` |
| Tasa de finalización de anuncios | Relación de anuncios finalizados frente a anuncios iniciados (%) | `Ad Completes / Ad Starts` |
| Tasa de finalización de capítulos | Relación de capítulos finalizados frente a capítulos iniciados (%) | `Chapter Completes / Chapter Starts` |
