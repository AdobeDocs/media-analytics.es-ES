...
Use `MEDIA_VideoMetadataKeyORIGINATOR` para establecer el originador en los metadatos estándar del objeto de medios antes de llamar a `mediaTrackSessionStart`:
