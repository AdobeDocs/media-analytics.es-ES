...
Use `MEDIA_VideoMetadataKeyASSET_ID` para establecer el ID de recurso en los metadatos estándar del objeto de medios antes de llamar a `mediaTrackSessionStart`:
