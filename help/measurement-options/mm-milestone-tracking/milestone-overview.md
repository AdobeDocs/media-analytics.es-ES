...
### Configuración de informes de hitos
...
| --- | --- | --- |
| Contenido | Caducidad <br/>predeterminada de la eVar: Visita | (Requerido) Recopila el nombre del vídeo tal como se especifica en la implementación. |
