...
Estas variables se utilizan para enviar información de publicidad junto con el método openAd. Consulte [Seguimiento de anuncios de vídeo VAST.](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html)
