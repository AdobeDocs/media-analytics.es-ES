...
| --- | --- | --- |
| Contenido | Caducidad <br/>predeterminada de evar: Visita | (Requerido) Recopila el nombre del vídeo tal como se especifica en la implementación. |
| Tipo de contenido | eVar <br/>Default expiration: Page view | Recopila datos sobre el tipo de contenido que un visitante ve. A las visitas enviadas por la medición de vídeo se les asigna un tipo de contenido `video.`<br/>de esta variable no necesita estar reservado exclusivamente para el seguimiento de vídeo. Tener otros tipos de contenido de informe de contenido usando esta misma variable permite analizar la distribución de visitantes en los distintos tipos de contenido. Por ejemplo, podría etiquetar otros tipos de contenido con valores como `article` o `product page` usando esta variable. <br/>Desde una perspectiva de medición de vídeo, *Tipo de contenido* permite identificar visitantes de vídeo y, por consiguiente, calcular las tasas de conversión de vídeo. |
