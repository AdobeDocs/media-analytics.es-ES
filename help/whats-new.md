...
| [Dispositivos y plataformas compatibles](https://docs.adobe.com/content/help/en/media-analytics/using/supported-devices.html) | 19 de febrero de 2019 | A continuación se enumeran las versiones de plataforma mínimas admitidas para cada SDK. <br>- iOS: iOS 6+ <br>- Android: Android 5.0+ - Lollipop <br>- Cromado: v22+<br>- Mozilla: v27+<br>- Safari: v7+<br>- IE: v1+ |
