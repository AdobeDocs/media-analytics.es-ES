...
| [Dispositivos y plataformas compatibles](https://experienceleague.adobe.com/docs/media-analytics/using/supported-devices.html?lang=es) | 18 de junio de 2020 | La [!UICONTROL Extensión Media Launch] con el SDK móvil de AEP ahora es compatible con los siguientes dispositivos OTT:<ul><li>Apple TV (tvOS)</li><li>Fire TV (sistema operativo Fire)</li><li>Android TV</li></ul> |
