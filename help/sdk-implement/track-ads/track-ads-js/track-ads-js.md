---
title: Seguimiento de publicidades con JavaScript 2.x
...
# Seguimiento de publicidades con JavaScript 2.x{#track-ads-on-javascript}
...
1. Opcionalmente, se pueden adjuntar metadatos estándar o de anuncio a la sesión de seguimiento de contenido mediante el uso de variables de datos de contexto.
   ...
   * [Implementación de metadatos de publicidad estándar en JavaScript](/help/sdk-implement/track-ads/impl-std-ad-metadata/impl-std-ad-md-js/impl-std-ad-metadata-js.md)
