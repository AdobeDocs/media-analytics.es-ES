---
seo-title: Un rastreador de VOD para varias sesiones
...
## Situación {#section_45D7B10031524411B91E2C569F7818B0}

En esta situación, se usa la instancia de `MediaHeartbeat` para crear dos sesiones independientes en una secuencia.

Este escenario es exactamente igual al escenario de [Reproducción de VOD sin anuncios](/help/sdk-implement/tracking-scenarios/vod-no-intrs-details.md).
...
## Código de muestra {#section_ndg_wdj_x2b}
