...
1. **Configurar identidad**<br>
   ...
   * **Implementaciones de Edge**: La identidad se administra mediante la configuración del área de nombres de identidad de Adobe Experience Platform. No se requiere una configuración del Servicio de ID de visitante independiente. Consulte [Descripción general de la implementación de Edge](/help/implementation/edge/overview.md) para obtener detalles.

   * **Implementaciones solo de Analytics**: El servicio de ID de visitante de Adobe debe estar habilitado para identificar visitantes de manera consistente en todas las soluciones de CX Enterprise. El servicio de ID de visitante asigna un ID único y persistente a cada visitante del sitio y permite que ese ID se comparta en todas las soluciones de CX Enterprise a las que se suscriba.

     Para obtener más información, consulte la [documentación del servicio de ID de visitante de Adobe](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=es).
