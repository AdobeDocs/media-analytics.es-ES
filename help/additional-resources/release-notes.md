...
* Últimas actualizaciones de la versión de [Adobe CX Enterprise](https://business.adobe.com/es/products/adobe-experience-cloud-products.html)
...
| Referencia a la cooperación entre dispositivos | Se ha eliminado la referencia a la cooperación entre dispositivos y el requisito del servicio de ID. | Agosto de 2022 |
...
| Función | Descripción | Fecha de objetivo o actualización |
| ----------- | ---------- | -------------- |
