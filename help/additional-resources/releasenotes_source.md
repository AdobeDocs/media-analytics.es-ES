...
---
# Nota de la versión de medios de transmisión: texto de origen

El siguiente contenido se ha copiado de las notas de la versión del Experience Cloud. Esto se trasladará a las nuevas notas de la versión de Streaming Media.
...
| Publicadas | Nombre | type | Descripción |
| ----------- | ---------- | ---------- | --------- |
