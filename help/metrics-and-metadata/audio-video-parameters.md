...
|   Implementación   | Parámetros de red | Creación de informes |
| --- | --- | --- |
| <ul> <li> **Clave de SDK:**<br/> STREAM_FORMAT </li> <li> **Clave de API:**<br/> media.streamFormat </li> <li> **Requerido:**<br/> no </li> <li> **Tipo:**<br/> cadena </li> <li> **Enviado con:**<br/> Inicio de contenidos, Cierre de contenidos </li> <li> **Mínima Versión de SDK:**  1.5.7 </li> <li> **Valor de muestra:**<br/> &quot;HD&quot; </li> <li> **Descripción:**<br/> Formato de la difusión (HD, SD)  </li></ul> | <ul> <li> **Adobe Analytics:**<br/> (a.media.format) </li> <li> **Heartbeats:**<br/> (s:meta:<br/>a.media.format) </li> </ul> | <ul> <li> **Disponible:**<br/> utilizar regla de procesamiento personalizada </li> <li> **Variable reservada:**<br/> N/D </li> <li> **Nombre del informe:**<br/> Personalizado </li> <li> **Datos de contexto:**<br/> (a.media.format) </li> <li> **Fuente de datos:**<br/> N/D </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.format) </li> <li> **Ruta de campo XDM:**<br/> media.mediaTimed.primaryAssetReference.streamFormat </li> </ul> |
...
|   Implementación   | Parámetros de red | Creación de informes |
| --- | --- | --- |
| <ul> <li> **Clave de SDK:**<br/> N/D </li> <li> **Clave de API:**<br/> N/D </li> <li> **Tipo:**<br/> número </li> <li> **Enviado con:**<br/> Cierre de contenidos </li> <li> **Mínima Versión de SDK:** Cualquiera </li> <li> **Valor de muestra:**<br/> 2 </li> <li> **Descripción:**<br/> el número de anuncios iniciados durante la sesión de medios.   <br/> </li></ul> | <ul> <li> **Adobe Analytics:**<br/> N/D </li> <li> **Heartbeat:**<br/> N/D </li> </ul> | <ul> <li> **Disponible:**<br/> utilizar regla de procesamiento personalizada </li> <li> **Variable reservada:**<br/> N/D </li> <li> **Nombre del informe:**<br/> Personalizado </li> <li> **Datos de contexto:**<br/> (a.media.adCount) </li> <li> **Fuente de datos:**<br/> N/D </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.adCount) </li> <li> **Ruta de campo XDM:**<br/> media.mediaTimed.adCount.value </li> </ul> |

### Recuento de capítulos

|   Implementación   | Parámetros de red | Creación de informes |
| --- | --- | --- |
| <ul> <li> **Clave de SDK:**<br/> N/D </li> <li> **Clave de API:**<br/> N/D </li> <li> **Tipo:**<br/> número </li> <li> **Enviado con:**<br/> Cierre de contenidos </li> <li> **Mínima Versión de SDK:** Cualquiera </li> <li> **Valor de muestra:**<br/> 2 </li> <li> **Descripción:**<br/> número de capítulos iniciados durante la sesión de medios.   <br/> </li></ul> | <ul> <li> **Adobe Analytics:**<br/> N/D </li> <li> **Heartbeat:**<br/> N/D </li> </ul> | <ul> <li> **Disponible:**<br/> utilizar regla de procesamiento personalizada </li> <li> **Variable reservada:**<br/> N/D </li> <li> **Nombre del informe:**<br/> Personalizado </li> <li> **Datos de contexto:**<br/> (a.media.chapterCount) </li> <li> **Fuente de datos:**<br/> N/D </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.chapterCount) </li> <li> **Ruta de campo XDM:**<br/> media.mediaTimed.chapterCount.value </li> </ul> |
