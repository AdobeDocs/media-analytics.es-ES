...
description: Obtenga información sobre las variables de datos de medios de transmisión principales, incluidos los datos de contenido de audio y vídeo y los valores de datos de contexto.
...
|   Implementación   | Parámetros de red | Creación de informes |
| --- | --- | --- |
| <ul> <li> **Clave de SDK:**<br/> N/D </li> <li> **Clave de API:**<br/> N/D </li> <li> **Tipo:**<br/> número </li> <li> **Enviado con:**<br/> Cierre de contenidos </li> <li> **Mínima Versión de SDK:** Cualquiera </li> <li> **Valor de muestra:**<br/> 2 </li> <li> **Descripción:**<br/> El número de anuncios iniciados durante la sesión de contenido.   <br/> </li></ul> | <ul> <li> **Adobe Analytics:**<br/> N/D </li> <li> **Heartbeat:**<br/> N/D </li> </ul> | <ul> <li> **Disponible:**<br/> utilizar regla de procesamiento personalizada </li> <li> **Variable reservada:**<br/> N/D </li> <li> **Nombre del informe:**<br/> Personalizado </li> <li> **Datos de contexto:**<br/> (a.media.adCount) </li> <li> **Fuente de datos:**<br/> N/D </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.adCount) </li> <li> **Ruta de campo XDM:**<br/> media.mediaTimed.adCount.value </li> </ul> |

### Recuento de capítulos

|   Implementación   | Parámetros de red | Creación de informes |
| --- | --- | --- |
| <ul> <li> **Clave de SDK:**<br/> N/D </li> <li> **Clave de API:**<br/> N/D </li> <li> **Tipo:**<br/> número </li> <li> **Enviado con:**<br/> Cierre de contenidos </li> <li> **Mínima Versión de SDK:** Cualquiera </li> <li> **Valor de muestra:**<br/> 2 </li> <li> **Descripción:**<br/> Número de capítulos iniciados durante la sesión de contenido.   <br/> </li></ul> | <ul> <li> **Adobe Analytics:**<br/> N/D </li> <li> **Heartbeat:**<br/> N/D </li> </ul> | <ul> <li> **Disponible:**<br/> utilizar regla de procesamiento personalizada </li> <li> **Variable reservada:**<br/> N/D </li> <li> **Nombre del informe:**<br/> Personalizado </li> <li> **Datos de contexto:**<br/> (a.media.chapterCount) </li> <li> **Fuente de datos:**<br/> N/D </li> <li> **Audience Manager:**<br/> (c_contextdata.<br/>a.media.chapterCount) </li> <li> **Ruta de campo XDM:**<br/> media.mediaTimed.chapterCount.value </li> </ul> |
