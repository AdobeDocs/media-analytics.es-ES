...
Esta situación es igual la de [Reproducción de VOD con anuncio previo a la emisión](/help/use-cases/tracking-scenarios/vod-preroll-ads.md) salvo por el hecho de que la aplicación permite al usuario omitir el anuncio (por ejemplo, haciendo clic en un botón de omitir).
...
| La pausa publicitaria termina. | `trackEvent:AdBreakComplete` | | Obligatorio incluso cuando se omitió el anuncio. Sin este evento, los eventos de publicidad se ignoran y la duración de la publicidad omitida se cuenta como contenido principal. |
| Se reproduce el contenido. | | Latidos de contenido | Estas llamadas de red son exactamente las mismas que la del caso de [Reproducción de VOD sin anuncios](/help/use-cases/tracking-scenarios/vod-no-intrs-details.md). |
...
Los parámetros son idénticos a los parámetros del escenario [Reproducción de VOD con anuncios previos a la emisión](/help/use-cases/tracking-scenarios/vod-preroll-ads.md), excepto que no hay una llamada de finalización de anuncio. `AdBreakComplete` sigue siendo necesario después de la omisión para cerrar la pausa publicitaria.
