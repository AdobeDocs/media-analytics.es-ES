...
Obtenga información sobre cómo configurar servicios de medios de streaming para dispositivos Android.
...
Para obtener más información acerca de la documentación de Adobe Mobile SDK, consulte [Android SDK 4.x para soluciones de Experience Cloud.](https://experienceleague.adobe.com/docs/mobile-services/android/overview.html?lang=es)
